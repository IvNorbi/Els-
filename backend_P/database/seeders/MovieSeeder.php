...
class MovieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $movie->imageUrl = "/storage/the_lord_of_the_rings_the_fellowship_of_the_ring.jpg";
        $movie->length = "178";
        ...
        $movie->imageUrl = "/storage/the_lord_of_the_rings_the_two_towers.jpg";
        $movie->length = "210";
        $movie->origin = "Új-Zéland, USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the_lord_of_the_rings_the_return_of_the_king.jpg";
        $movie->length = "201";
        $movie->origin = "Új-Zéland, USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the_sunset_limited.jpg";
        $movie->length = "91";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the_godfather.jpg";
        $movie->length = "175";
        $movie->origin = "USA";
        $movie->save();
        ...
        ";
        $movie->imageUrl = "/storage/the_godfather_2.jpg";
        $movie->length = "200";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the_godfather_3.jpg";
        $movie->length = "170";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the _shawshank_redemption.jpg";
        $movie->length = "137";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the_wizard_of_oz.jpg";
        $movie->length = "102";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the_green_mile.jpg";
        $movie->length = "189";
        $movie->origin = "USA";   
        $movie->save();
    }

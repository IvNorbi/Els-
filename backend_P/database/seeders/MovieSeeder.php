...
class MovieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $movie->imageUrl = "/storage/one-piece-film-red-official.webp";
        $movie->length = "115";
        $movie->origin = "Japán";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/batman_begins.jpg";
        $movie->length = "140";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the_dark_knight.jpg";
        $movie->length = "152";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "/storage/the_dark_knight_rises.jpg";
        $movie->length = "164";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\jujutsu_kaisen_0.jpg";
        $movie->length = "105";
        $movie->origin = "Japán";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\the_lord_of_the_rings_the_fellowship_of_the_ring.jpg";
        $movie->length = "178";
        ...
        $movie->imageUrl = "..\storage\app\public\the_lord_of_the_rings_the_two_towers.jpg";
        $movie->length = "210";
        $movie->origin = "Új-Zéland, USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\the_lord_of_the_rings_the_return_of_the_king.jpg";
        $movie->length = "201";
        $movie->origin = "Új-Zéland, USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\the_sunset_limited.jpg";
        $movie->length = "91";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\interstellar.jpg";
        $movie->length = "169";
        $movie->origin = "UK, USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\the_godfather.jpg";
        $movie->length = "175";
        $movie->origin = "USA";
        $movie->save();
        ...
        ";
        $movie->imageUrl = "..\storage\app\public\the_godfather_2.jpg";
        $movie->length = "200";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\the_godfather_3.jpg";
        $movie->length = "170";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\the _shawshank_redemption.jpg";
        $movie->length = "137";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\schindler's_list.jpg";
        $movie->length = "195";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\raging_bull.jpg";
        $movie->length = "129";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\casablanca.jpg";
        $movie->length = "102";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\gone_with_the_wind.jpg";
        $movie->length = "238";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\the_wizard_of_oz.jpg";
        $movie->length = "102";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\oz_the_great_and_powerful.jpg";
        $movie->length = "127";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_iv_a_new_hope.jpg";
        $movie->length = "121";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_v_the_empir_strikes_back.jpg";
        $movie->length = "124";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_vi_return_of_the_jedi.jpg";
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_i_the_phantom_menace.jpg";
        $movie->length = "136";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_ii_ attack_of_the_clones.jpg";
        $movie->length = "142";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_iii_revenge_of_the_sith.jpg";
        $movie->length = "143";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_vii_the_force_awakens.jpg";
        $movie->length = "136";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_viii_the_last_jedi.jpg";
        $movie->length = "150";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\star_wars_episode_ix_the_rise_of_skywalker.jpg";
        $movie->length = "142";
        $movie->origin = "USA";
        $movie->save();
        ...
        $movie->imageUrl = "..\storage\app\public\the_green_mile.jpg";
        $movie->length = "189";
        $movie->origin = "USA";   
        $movie->save();
    }
